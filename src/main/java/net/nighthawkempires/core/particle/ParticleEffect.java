package net.nighthawkempires.core.particle;

import net.nighthawkempires.core.reflection.ReflectionUtils;
...
import static net.nighthawkempires.core.reflection.ReflectionUtils.*;
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    setValue(packet, true, "a", name);
                } else {
                    setValue(packet, true, "a", enumParticle.getEnumConstants()[effect.getId()]);
                    setValue(packet, true, "j", longDistance);
                    if (data != null) {
                        int[] packetData = data.getPacketData();
                        setValue(packet, true, "k", effect == ParticleEffect.ITEM_CRACK ? packetData : new int[] { packetData[0] | (packetData[1] << 12) });
                    }
                }
